...
### Preset E — "Tiam Designs" (Maker Portfolio)
- **Identity:** A high-precision machine shop meets a sleek consumer tech display.
- **Palette:** Void `#101214` (Primary), Ember `#F75142` (Accent), Sand `#F6F4EF` (Background), Brass `#C1AB85` (Text/Dark)
- **Typography:** Headings: "Inter" (tight tracking). Drama: "Inter" Black (tight tracking). Data: `"JetBrains Mono"`.
- **Image Mood:** cnc machining, mechanical engineering, raw aluminum, warm lighting.
- **Hero line pattern:** "[Role/Skill string]." (Bold Sans) / "Hi, I'm [Name]." (Massive Sans-serif)
